...
#define MyAppURL "https://github.com/yourusername/DesktopBanner"
...
WizardStyle=modern
; WizardImageFile=install-bg.bmp
...
VersionInfoDescription=DoD Security Banner Tool for Windows Desktop
...
Source: "..\bin\Release\net6.0-windows\win-x64\*.dll"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs
Source: "..\bin\Release\net6.0-windows\win-x64\*.json"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs
Source: "..\bin\Release\net6.0-windows\win-x64\*.deps.json"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\bin\Release\net6.0-windows\win-x64\*.runtimeconfig.json"; DestDir: "{app}"; Flags: ignoreversion
